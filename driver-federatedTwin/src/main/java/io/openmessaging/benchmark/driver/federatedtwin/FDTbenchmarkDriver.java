...
public class FDTbenchmarkDriver implements BenchmarkDriver {
    ...
    public CompletableFuture<Void> createTopics(List<TopicInfo> topicInfos) {
        ...
        FDTtopicCreator topicCreator =
                new FDTtopicCreator(admin, topicConfigs, config.replicationFactor);
    ...
    public CompletableFuture<BenchmarkProducer> createProducer(String topic) {
        ...
        BenchmarkProducer benchmarkProducer = new FDTbenchmarkProducer(kafkaProducer, topic);
        try {
    ...
    public CompletableFuture<BenchmarkConsumer> createConsumer(
        ...
        String digitalObjects = "latestFederatedDigitalObjects";
        ...
        try {
            ...
            return CompletableFuture.completedFuture(
                    new FDTbenchmarkConsumer(consumer, consumerProperties, consumerCallback));
        } catch (Throwable t) {
            consumer.close();
