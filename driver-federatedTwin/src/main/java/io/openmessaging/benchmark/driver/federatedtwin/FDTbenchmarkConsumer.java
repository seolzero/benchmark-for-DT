...
public class FDTbenchmarkConsumer implements BenchmarkConsumer {

    private static final Logger log = LoggerFactory.getLogger(FDTbenchmarkConsumer.class);
