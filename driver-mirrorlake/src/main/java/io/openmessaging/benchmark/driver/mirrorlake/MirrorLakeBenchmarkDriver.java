...
public class MirrorLakeBenchmarkDriver implements BenchmarkDriver {
    ...
    public CompletableFuture<Void> createTopics(List<TopicInfo> topicInfos) {
        ...
        MirrorLakeTopicCreator topicCreator =
                new MirrorLakeTopicCreator(admin, topicConfigs, config.replicationFactor);
    ...
    public CompletableFuture<BenchmarkProducer> createProducer(String topic) {
        ...
        BenchmarkProducer benchmarkProducer = new MirrorLakeBenchmarkProducer(kafkaProducer, topic);
        try {
    ...
    public CompletableFuture<BenchmarkConsumer> createConsumer(
        ...
        String digitalObjects = "latestDigitalObjects";
        ...
        try {
            consumer.subscribe(Arrays.asList(digitalObjects));
            return CompletableFuture.completedFuture(
                    new MirrorLakeBenchmarkConsumer(consumer, consumerProperties, consumerCallback));
        } catch (Throwable t) {
            consumer.close();
