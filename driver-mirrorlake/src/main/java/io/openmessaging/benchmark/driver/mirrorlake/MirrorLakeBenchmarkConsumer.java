...
public class MirrorLakeBenchmarkConsumer implements BenchmarkConsumer {

    private static final Logger log = LoggerFactory.getLogger(MirrorLakeBenchmarkConsumer.class);
    ...
    public MirrorLakeBenchmarkConsumer(
                                    ...
                                    for (ConsumerRecord<String, String> record : records) {
                                        ...
                                        log.info(
                                                "message : "
                                                        ...
                                                        + " -- "
                                                        + record.timestamp());
                                        log.info("message : " + record.topic() + " -- " + record.partition());
                                        callback.messageReceived(record.value().getBytes(), record.timestamp());
